...
public interface VideoRestController {
    ...
    ResponseEntity<VideoUploadResponse> uploadVideo(
            @Parameter(description = "Video file to upload (max 500MB, supported formats: mp4, avi, mov, wmv, flv, webm, mkv)", required = true)
